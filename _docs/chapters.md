      ...
      <div class="card shadow-sm border-0">
        ...
        <div class="card-body">
          <p class="card-text lead drop-cap">{{ chapters.sent-1 }}
            Although J was the last letter added to the English alphabet, this digital anthology begins almost four thousand years
            ago on a trade route accross the Theban Plateau during Egypt's Late Middle Kingdom.
          </p>
              ...
              <div class="row g-0">
                <div class="col-4">
                  <img src="../assets/images/scenes/leaving-the-nile-valley.png" alt="A satellite image of the River Nile"
                    class="rounded shadow-sm" style="width: 352px; height: 192px; object-fit: cover;">
                  </div>
                </div>
                <div class="col-8">
                  <div class="card-body p-2">
                    <h6 class="card-title mb-1 fw-bold" style="font-size: 0.9rem;">{{ scene.title }}</h6>
                    <p class="card-text text-muted" style="font-size: 0.8rem;">
                      {{ scene.content | strip_html | truncate: 80 }}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div class="row g-3 align-items-center chapter-card pt-2">
          <div class="col-auto">
            <img src="assets/images/stories/leaving-the-nile-valley.png" alt="A satellite image of the River Nile"
              class="rounded shadow-sm" style="width: 352px; height: 192px; object-fit: cover;">
          </div>
          <div class="col">
            <div class="d-flex justify-content-between align-items-start">
              <h5 class="card-title mb-1"><small class="text-uppercase text-muted fw-bold">Chapter III: the
                  Encampment</small></h5>
            </div>
        ...
        <div class="row g-3 align-items-center chapter-card pt-2">
          <div class="col-auto">
            <img src="{{ scenes.thumbnail }}" class="rounded shadow-sm" style="width: 352px; height: 192px; object-fit: cover;">
          </div>
          <div class="col">
            <h5 class="card-title mb-1"><small class="text-uppercase text-muted fw-bold">Scene {{ scene.scene_number }}: {{
                scene.title }}</small></h5>
            <p class="card-text text-muted small mb-0">
              {{ scene.excerpt }}
              <a href="{{ scenes.url }}" class="link-primary text-decoration-none fw-bold">Read more →</a>
            </p>
          </div>
...
<div class="list-group list-group-flush">
  <div class="list-group-item py-3 border-0">
    <div class="row g-3 align-items-center chapter-card">
      ...
      <div class="col">
        <div class="d-flex justify-content-between align-items-start">
          <h5 class="card-title mb-1"><small class="text-uppercase text-muted fw-bold">Scene: the Ascent</small></h5>
        </div>
        <p class="card-text text-muted small mb-0">
          Standing along an ancient road at the Wadi el-Hol (Valley of Terror), just west of the Nile, and north of
          Luxor, where
          soldiers, mercenaries, and caravans of traders once traveled between the ancient cities of Thebes and Abydos.
          <a href="/scenes/leaving-the-nile-valley" class="link-primary text-decoration-none fw-bold">Read more →</a>
        </p>
      </div>
    </div>
    <div class="row g-3 align-items-center chapter-card pt-2">
      ...
      <div class="col">
        <div class="d-flex justify-content-between align-items-start">
          <h5 class="card-title mb-1"><small class="text-uppercase text-muted fw-bold">Chapter II: the Crossing</small>
          </h5>
        </div>
        <p class="card-text text-muted small mb-0">
          Carved into the soft limestone cliffs, by Semites some 4000 years ago (during the Middle Kingdom period,
          ...
          <a href="/stories/the-crossing" class="link-primary text-decoration-none fw-bold">Read more →</a>
        </p>
      </div>
    </div>
